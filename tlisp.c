...
void lenv_add_builtins(lenv *e)
{
  ...
  lenv_add_builtin(e, "голова", builtin_head);
  lenv_add_builtin(e, "хвост", builtin_tail);
...
int main(int argc, char **argv)
{
  ...
  mpca_lang(MPCA_LANG_DEFAULT,
      ...
      lispy  : /^/ <expr>* /$/ ;                           \
    ",
            Number, Symbol, Sexpr, Qexpr, String, Comment, Expr, Lispy);
  ...
  mpc_cleanup(6, Number, Symbol, Sexpr, Qexpr, String, Comment, Expr, Lispy);
